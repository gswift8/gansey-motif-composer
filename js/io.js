...
function project(){return {version:9,motifs,panels,targetWidth:+$("targetWidth").value,activePanel,selectedSectionId}}
function restore(p){
...
$("exportJson").onclick=()=>{
 ...
 a.href=URL.createObjectURL(blob);a.download="gansey-studio-project-v0.9.0.json";a.click();URL.revokeObjectURL(a.href)
};
...
$("saveLocal").onclick=()=>{localStorage.setItem("ganseyStudioV90",JSON.stringify(project()));alert("Project saved in this browser.")};
$("loadLocal").onclick=()=>{
 const raw=localStorage.getItem("ganseyStudioV90")||localStorage.getItem("ganseyStudioV84")||localStorage.getItem("ganseyStudioV83")||localStorage.getItem("ganseyStudioV82")||localStorage.getItem("ganseyStudioV81")||localStorage.getItem("ganseyStudioV8")||localStorage.getItem("ganseyStudioV7")||localStorage.getItem("ganseyStudioV4")||localStorage.getItem("ganseyComposerV2");
