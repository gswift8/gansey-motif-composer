...
function project(){return {version:11,motifs,panels,targetWidth:+$("targetWidth").value,activePanel,selectedSectionId}}
function restore(p){
...
$("exportJson").onclick=()=>{
 ...
 a.href=URL.createObjectURL(blob);a.download="gansey-studio-project-v0.11.0.json";a.click();URL.revokeObjectURL(a.href)
};
