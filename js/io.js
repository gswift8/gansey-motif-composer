...
function project(){return {version:13,projectName:$("projectName")?.value||"Untitled Gansey",motifs,panels,targetWidth:+$("targetWidth").value,activePanel,selectedSectionId}}
function restore(p){
...
$("exportJson").onclick=()=>{
 ...
 a.href=URL.createObjectURL(blob);a.download="gansey-studio-project-v0.13.0.json";a.click();URL.revokeObjectURL(a.href)
};
